...
```typescript
// Who's typing on the other side?
...
const mafe: Developer = {
  name:      "Maria Fernanda Arias",
  role:      "Full Stack Developer",
  focus:     ["Clean Architecture", "SOLID Principles", "Systems that scale"],
  currently: ["Building my engineering portfolio", "Learning IaC & Hexagonal Architecture"],
...
<sub>Made with ☕ and clean code</sub>
